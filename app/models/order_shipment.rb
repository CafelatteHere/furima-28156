class OrderShipment
  ...
  def save
    ...
    Shipment.create(prefecture_id: prefecture_id, zip_code: zip_code, city: city, house_number: house_number, building_name: building_name, tel: tel, order_id: order.id)
  end
end